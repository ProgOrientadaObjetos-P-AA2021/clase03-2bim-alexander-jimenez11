...
public class Ejecutor {
     public static void main(String[] args) {
        ...
        ReporteDocente rd= new ReporteDocente("001Doc");
        rd.lista=listaDocente;
        rd.getPromedioSueldos();
        
        
        ReporteEstudiante re = new ReporteEstudiante("001Est");
        re.lista=listaEstudiante;
        re.getPromedioMatriculas();
        
        ReportePolicia rp = new ReportePolicia("001Pol");
        rp.lista=listaPolicia;
        rp.getPromedioEdad();
